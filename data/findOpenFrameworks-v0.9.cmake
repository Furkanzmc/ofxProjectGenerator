...
if(AR STREQUAL "x64" OR AR STREQUAL "Win32")
    message("NOTICE: Compiling openFrameworks for ${AR}")
else()
    set(AR x64)
    message("NOTICE: Architecture is not set. Defaulting to x64")
endif()
...
if (USE_PRECOMPILED_LIB)
    ...
    if (EXISTS ${OF_LIB_PATH})
        ...
        message("NOTICE: Using precompiled openFrameworks")
    else()
        set(USE_PRECOMPILED_LIB false)
        message("NOTICE: Compiling openFrameworks from source")
    endif()
else()
    message("NOTICE: Compiling openFrameworks from source")
